...
hot_events <- event_detect(geyser_data$server_stamp, hot_flow, start_threshold, stop_threshold, 1)
...
cold_events <- event_detect(geyser_data$server_stamp, cold_flow, start_threshold, stop_threshold, 2)
